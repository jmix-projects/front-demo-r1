...
@Table(name = "DATATYPES_TEST_ENTITY")
@JmixEntity
@Entity(name = "DatatypesTestEntity")
public class DatatypesTestEntity {
    ...
    @JoinTable(name = "DATATYPES_TEST_ENTITY_ASSOCIATION_M2M_TEST_ENTITY_LINK",
    ...
    @JoinTable(name = "DATATYPES_TEST_ENTITY_INTEGER_ID_TEST_ENTITY_LINK",
            joinColumns = @JoinColumn(name = "DATATYPES_TEST_ENTITY_ID"),
